...
SECRET_KEY = 'django-insecure-r6$wh9gvuj*yo!1l5h#414$zt-!qwnees=6e(#05y)-3##o$l3'
...
LOGIN_REDIRECT_URL = 'dashboard' # сообщает URL-адрес, на который следует перенаправлять пользователя после успешного входа
...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend' # указывает класс, который будет использоваться для отправки электронной почты
...
AUTHENTICATION_BACKENDS = [
    ...
    'account.authentication.EmailAuthBackend', # бекенд авторизации через почту
